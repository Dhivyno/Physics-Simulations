float m1 = 10;  // mass of first pendulum
...
void draw() {
 ...
 m1_acc = (-g*(2*m1+m2)*sin(ang1)-m2*g*sin(ang1-2*ang2)-2*sin(ang1-ang2)*m2*(m2_velocity*m2_velocity*l2+m1_velocity*m1_velocity*l1*cos(ang1-ang2)))/(l1*(2*m1+m2-m2*cos(2*ang1-2*ang2)));
 m2_acc = (2*sin(ang1-ang2)*(m1_velocity*m1_velocity*l1*(m1+m2)+g*(m1+m2)*cos(ang1)+m2_velocity*m2_velocity*l1*m2*cos(ang1-ang2)))/(l2*(2*m1+m2-m2*cos(2*ang1-2*ang2)));
